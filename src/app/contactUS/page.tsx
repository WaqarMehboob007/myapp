...
<div className="px-4 mx-auto flex flex-col py-10">
      <div className="max-w-2xl mx-auto mb-18 text-center">
            ...
            <h1 className="md:text-5xl text-xl font-bold text-black md:my-10">
                  <p> Anything Unclear Or</p><span className="font-serif italic"> need help</span><span>?</span>
            </h1>
            <p className="md:text-xl text-sm text-gray-500 font-semibold my-4 md:mb-20">Relax, we are ready to support 24/7 for you</p>
      </div>

      <div className="flex justify-center mx-4 gap-4 my-10">
            <div className="flex flex-wrap justify-center -mx-4">
                  <div className="w-full md:w-1/2 px-4 md:px-10 mb-10 md:mb-0">
                        <div className="max-w-sm mx-auto md:h-full py-8 px-6 bg-white border border-gray-200 rounded-3xl">
                              <div className="max-w-2xs mx-auto text-center items-center ">
                                    <div className='md:h-28 md:pb-6 flex justify-center flex-1'>
                                          <Image className="mx-auto mb-3 h-10 w-10 md:h-full md:w-auto" src="/images/email.png" width={100} height={100} alt="Portfolio Logo"/>
                                    </div>
                                    <div className='h-12 pb-1'>
                                          <h5 className="text-2xl font-bold text-gray-900 ">Contact Us</h5>
                                    </div>
                                    <div className='h-20 pb-6'>
                                          <p className="text-gray-500">Send queries via email, we will reply you as soon as possible</p>
                                    </div>
                                    <div className='h-12 pb-6'>
                                          <span className="block text-sm text-orange-900 mb-8">cgs.waqar@gmail.com</span>
                                    </div>
                                    <div>
                                          <Link className="top-4 relative group inline-block py-4 px-6 text-white font-semibold bg-orange-900 rounded-full overflow-hidden" href="/contactUS/EmailUs">
                  ...
                  <div className="w-full md:w-1/2 px-4 md:px-10 mb-10 md:mb-0 ">
                        <div className="max-w-sm mx-auto h-full py-8 px-6 bg-white border border-gray-200 rounded-3xl">
                              <div className="max-w-2xs mx-auto text-center gap-y-1">
                                    <div className='h-28 pb-6'>
                                          <Image className="block mx-auto mb-3" src="/images/support.png" width={60} height={60} alt="Portfolio Logo"/>
                                    </div>
                                    <div className='h-12 pb-1'>
                                          <h5 className="text-2xl font-bold text-gray-900 ">Customer Service</h5>
                                    </div>
                                    <div className='h-20 pb-6'>
                                          <p className="text-gray-500 mb-3">Call the helpline</p>
                                    </div>
                                    <div className='h-12 pb-6'>
                                          <span className="block text-sm text-orange-900">+92 312 3456789</span>
                                    </div>
                                    <div>
                                          <Link className="top-4 relative group inline-block py-4 px-6 text-white font-semibold bg-orange-900 rounded-full overflow-hidden" href="/contactUS/EmailUs">
                                                <div className="absolute top-0 right-full w-full h-full bg-gray-900 transform group-hover:translate-x-full group-hover:scale-102 transition duration-500"></div>
...
{/* <div className="w-full md:w-1/2 lg:w-auto px-4 xl:px-10 xsm:mb-3 border ">
<div className="max-w-sm mx-auto h-full py-8 px-6 bg-white border border-amber-400 rounded-3xl">
      <div className="max-w-2xs mx-auto text-center">
            <Image className="block mx-auto mb-3" src="/images/email.png" width={80} height={80} alt="Portfolio Logo"/>
            <h5 className="text-2xl font-bold text-gray-900 mb-3">Contact Us</h5>
            <p className="text-gray-500 mb-3">Send your query via an email</p>
            <span className="block text-sm text-orange-900 mb-8"> cgs.waqar@gmail.com</span>
            <Link className="relative group inline-block py-4 px-6 text-white font-semibold bg-orange-900 rounded-full overflow-hidden" href="/Contact/EmailUs">
                  <div className="absolute top-0 right-full w-full h-full bg-gray-900 transform group-hover:translate-x-full group-hover:scale-102 transition duration-500"></div>
                  <div className="relative flex items-center justify-center">
                        <span className="mr-4">Contact</span>
                        <span>
...
<div className="max-w-sm mx-auto h-full py-8 px-6 bg-white border border-gray-200 rounded-3xl">
<div className="max-w-2xs mx-auto text-center">
{/* <Image  src="saturn-assets/images/contact/icon-orange-headphones.svg" alt=""> */}
...
<span className="block text-sm text-orange-900 mb-8">+92 3xx 1234567</span>
<Link className="relative group inline-block py-4 px-6 text-white font-semibold bg-orange-900 rounded-full overflow-hidden" href="#">
      <div className="absolute top-0 right-full w-full h-full bg-gray-900 transform group-hover:translate-x-full group-hover:scale-102 transition duration-500"></div>
      <div className="relative flex items-center justify-center">
      <span className="mr-4">Call Now</span>
      <span>
      <svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            // <div className="flex flex-wrap justify-center -mx-4">
            //       <div className="w-full md:w-1/2  px-4 xl:px-10 mb-10 md:mb-0 xsm:w-auto">
            //             <div className="max-w-sm mx-auto h-full py-8 px-6 bg-white border border-gray-200 rounded-3xl">
            //                   <div className="max-w-2xs mx-auto text-center items-center ">
            //                               <div className='h-28 pb-6'>
            //                                     <Image className="block mx-auto mb-3" src="/images/email.png" width={80} height={80} alt="Portfolio Logo"/>
            ...
            //                               </div>
            //                               <div>
            //                                     <Link className="top-4 relative group inline-block py-4 px-6 text-white font-semibold bg-orange-900 rounded-full overflow-hidden" href="/Contact/EmailUs">
            //                                           <div className="absolute top-0 right-full w-full h-full bg-gray-900 transform group-hover:translate-x-full group-hover:scale-102 transition duration-500"></div>
            //                                           <div className="relative flex items-center justify-center">
            //                                           <span className="mr-4">Contact</span>
            //                                           <span>
            ...
            //             </div>
            //       </div>
            //       <div className="w-full md:w-1/2  px-4 xl:px-10 ">
            //             <div className="max-w-sm mx-auto h-full py-8 px-6 bg-white border border-gray-200 rounded-3xl">
            //                   <div className="max-w-2xs mx-auto text-center gap-y-1 items-center">
            //                               <div className='h-28 pb-6'>
            //                                     <Image className="block mx-auto mb-3" src="/images/support.png" width={60} height={60} alt="Portfolio Logo"/>
            //                               </div>
            //                               <div className='h-12 pb-1'>
            ...
            //                               </div>
            //                               <div className='h-12 pb-6'>
            //                                     <span className="block text-sm text-orange-900">+92 307 4348086</span>
            //                               </div>
            //                               <div>
            //                                     <Link className="top-4 relative group inline-block py-4 px-6 text-white font-semibold bg-orange-900 rounded-full overflow-hidden" href="/Contact/EmailUs">
            //                                           <div className="absolute top-0 right-full w-full h-full bg-gray-900 transform group-hover:translate-x-full group-hover:scale-102 transition duration-500"></div>
